...
int main() {
    ...
    cout << "Прізвище : " << left << setw(13) << surname << "Ім'я : " << left << setw(14) << name << " \t По батькові : " << patronymic << endl;

    cout << "Номер телефону : " << left << setw(27) << phoneNumber << " Хоббі : " << hobby << endl;

    cout << "Місце навчання : " << left << setw(27) << educationPlace << " Група : " << group << endl;

    cout << "Дата народження : " << left << setw(26) << birthDate << " Стать : " << gender << endl;

...
int main() {
    ...
    cout << "Прізвище : " << surname << setw(13) << " Ім'я : " << name << setw(21) << " По батькові : " << patronymic << endl;

    cout << "Номер телефону : " << phoneNumber << setw(17) << " Хоббі : " << hobby << endl;

    cout << "Місце навчання : " << educationPlace << setw(25) << " Група : " << group << endl;

    cout << "Дата народження : " << birthDate << setw(20) << " Стать : " << gender << endl;
